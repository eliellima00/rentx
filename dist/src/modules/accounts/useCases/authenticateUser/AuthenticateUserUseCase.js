...
let AuthenticateUserUseCase = class AuthenticateUserUseCase {
    ...
    execute({ email, password }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { expires_in_token, secret_refresh_token, secret_token, expires_in_refresh_token, expires_refresh_tokens_days, } = auth_1.default;
            if (!user) {
            ...
            const refresh_token_expires_date = this.dateProvider.addDays(expires_refresh_tokens_days);
